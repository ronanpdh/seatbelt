...
- Removing events from the end of the file is not detectable from the file alone. Closing that gap needs the final hash recorded somewhere the writer cannot rewrite, which is the job of signed attestation (planned for 0.0.4).
